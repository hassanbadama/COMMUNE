...
<header>
   ...
   <?php $reponse=$bdd->query("SELECT * FROM annonce"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?>
        <h1 class="titremariage"><?php echo $donne["titrea"]?></h1>
         <img src="admin/images/<?php echo $donne["image"]?> " alt="" width="800px" height="300px">
         <h4 class="titremariage"> <?php echo $donne["nomh"]?> & <?php echo $donne["nomf"]?></h4>
         <?php echo $donne["textea"]?>
     <?php } ?>
   </section>
   <footer class="parti">
 <?php 
