...
<header>
 ...
 <?php $reponse=$bdd->query("SELECT * FROM mission"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?> <br> <br>
        <h1 class="titremariage"><?php echo $donne["titrem"]?></h1>
        <?php echo $donne["textem"]?>
         <img src="admin/images/<?php echo $donne["imagem"]?> " alt="" width="800px" height="300px" class="imagemariage"> <br> <br>
