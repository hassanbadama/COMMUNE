...
<header>
 ...
 <?php $reponse=$bdd->query("SELECT * FROM projet"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?> <br> <br>
        <h1 class="titremariage"><?php echo $donne["titrepr"]?></h1>
         <img src="admin/images/<?php echo $donne["imagefontpr"]?> " alt="" width="800px" height="300px" class="imagemariage"> <br> <br>
         <?php echo $donne["textepr"]?>
     <?php } ?>
 </section>
 <footer class="parti">
 <?php 
