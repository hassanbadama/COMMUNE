...
<header>
 ...
 <?php $reponse=$bdd->query("SELECT * FROM space"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?> <br> <br>
        <h1 class="titremariage"><?php echo $donne["titres"]?></h1>
         <img src="admin/images/<?php echo $donne["images"]?> " alt="" width="800px" height="300px" class="imagemariage"> <br> <br>
         <?php echo $donne["textes"]?>
     <?php } ?>
 </section>
