...
<header>
 ...
 <?php $reponse=$bdd->query("SELECT * FROM marchepublic"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?> <br> <br>
        <h1 class="titremariage"><?php echo $donne["titre"]?></h1>
         <img src="admin/images/<?php echo $donne["image"]?> " alt="" width="800px" height="300px" class="imagemariage"> <br> <br>
         <?php echo $donne["texte"]?>
     <?php } ?>
 </section>
