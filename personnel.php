...
<body>
 ...
 <div class="photo1">
    ...
    <?php 
      ...
      <div class="pho">
      <img src="admin/images/<?php echo $donne["photo"]?> " alt="" width="300px" height="300px" class="pho1"> 
       <div class="pho2">
       <?php echo $donne["nom"]?> <?php echo $donne["prenom"]?> <br>
        <?php echo $donne["fonction"]?> <br>
        <a class="telechar" href="admin/images/<?php echo $donne["cv"]?>"> TELECHARGEMENT CV </a> <br>
       </div>
           <?php echo $donne["texte"]; ?> <a class="telechar" href="admin/images/<?php echo $donne["cv"]?>"> plus info... </a>
        </div>
        <?php } ?>
    </div>
  </div>
 ...
 <div class="photo1">
    ...
    <?php 
          ...
          <?php $reponse->execute(array("Conseil Municipal")) ?>
     	<?php while ($donne=$reponse->fetch()) { ?>
      <div class="pho">
      <img src="admin/images/<?php echo $donne["photo"]?> " alt="" width="300px" height="300px" class="pho1"> 
       <div class="pho2">
 ...
 <div class="photo1">
    <div class="photo2">
    <?php 
          $reponse=$bdd->prepare("SELECT * FROM personnel"); ?>
