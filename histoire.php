...
<header>
 ...
 <?php $reponse=$bdd->query("SELECT * FROM histoire"); ?>
  	<?php while ($donne=$reponse->fetch()) { ?> <br> <br>
        <h1 class="titremariage"><?php echo $donne["titreh"]?></h1>
         <img src="admin/images/<?php echo $donne["imagefonth"]?> " alt="" width="800px" height="300px" class="imagemariage"> <br> <br>
         <?php echo $donne["texteh"]?>
     <?php } ?>
 </section>
 <footer class="parti">
 <?php 
